...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    // OK (1): Create a method that shows a MediaStyle notification with two actions (play/pause, skip to previous). Clicking on the notification should launch this activity. It should take one argument that defines the state of MediaSession.

    private void showMidiaNotification(PlaybackStateCompat state) {
        ...
        if(state.getState() == PlaybackStateCompat.STATE_PLAYING) {
            ...
            playOrPause = getString(R.string.pause);
        ...
        NotificationCompat.Action playPauseAction = new NotificationCompat.Action(
                icon, playOrPause, MediaButtonReceiver.buildMediaButtonPendingIntent(this, PlaybackStateCompat.ACTION_PLAY_PAUSE));
        ...
        notificationBuilder.setContentTitle(getString(R.string.guess))
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        // OK (2): Call the method to show the notification, passing in the PlayBackStateCompat object.

        showMidiaNotification(mStateBuilder.build());
    }
