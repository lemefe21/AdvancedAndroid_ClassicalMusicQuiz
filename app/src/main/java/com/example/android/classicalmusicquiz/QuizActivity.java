...
// OK (1): Have this Activity implement ExoPlayer.EventListener and add the required methods.
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private void initializePlayer(Uri mediaUri) {
        if (mExoPlayer == null) {
            ...
            // OKs (2): Set the ExoPlayer.EventListener to this activity
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        // OK (3): Add conditional logging statements to the onPlayerStateChanged() method that log when ExoPlayer is playing or paused.
        if((playbackState == ExoPlayer.STATE_READY) && playWhenReady) {

            Log.d(TAG, "onPlayerChanged: PLAYING");

        } else if(playbackState == ExoPlayer.STATE_READY) {

            Log.d(TAG, "onPlayerChanged: PAUSED");
